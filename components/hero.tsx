        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <motion.div {...fadeUp(0.42)} className="flex flex-wrap items-center gap-3">
              <a
                href="#newsletter"
                className="group inline-flex items-center gap-2 rounded-full h-12 px-7 font-medium text-sm bg-primary hover:bg-primary/88 active:scale-[0.97] text-white transition-[background-color,transform] duration-200"
              >
                Get the newsletter
