        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <motion.div {...fadeUp(0.42)} className="flex flex-wrap items-center gap-3">
              <a
                href="#newsletter"
                className="group inline-flex items-center gap-2 rounded-full h-12 px-7 font-bold text-sm bg-primary hover:bg-primary/88 text-white transition-colors duration-200"
              >
                Get the newsletter
              ...
              <Tooltip>
                <TooltipTrigger>
                  <a
                    href="#ideas"
                    className="inline-flex items-center rounded-full h-12 px-7 font-bold text-sm text-foreground hover:text-primary border border-black/10 hover:border-primary/30 transition-all duration-200"
                    tabIndex={-1}
                  >
                    Browse ideas
                  </a>
