            ...
            <motion.div {...fadeUp(0.42)} className="flex flex-wrap items-center gap-3">
              ...
              <Tooltip>
                <TooltipTrigger>
                  <a
                    href="#ideas"
                    className="inline-flex items-center rounded-full h-12 px-7 font-bold text-sm text-foreground hover:text-primary active:scale-[0.97] border border-black/10 hover:border-primary/30 transition-[color,border-color,transform] duration-200"
                    tabIndex={-1}
                  >
                    Browse ideas
                  </a>
